...
class OgtFinder {
    ...
    static findAllTaskWrappers(): OgtTaskWrapper[] {
        const elements = OgtTaskWrapper.findAllElementsInDOM(document);
    ...
    static findAddNewButton(): OgtAddNewButton | null {
        const element = OgtAddNewButton.findElement();
    ...
    static findTaskContainer(): OgtTaskContainer | null {
        const element = OgtTaskContainer.findElement();
        if (!element) {
            return null;
        }
    ...
    static findAllTaskContainers(): OgtTaskContainer[] {
        const elements = OgtTaskContainer.findAllElements();
    ...
    static findViewMore(): OgtViewMore | null {
        const element = OgtViewMore.findElement()
        if (!element) {
            return null;
        }
    ...
    static findDeleteConfirmDialog(): any {
        const element = OgtDeleteConfirmDialog.findElement();
        if (!element) {
            return null;
        }
