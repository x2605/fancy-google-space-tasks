// dom_bringer/task_element/title_wrapper/title_editor.ts
...
class OgtTitleEditor {
     ...
     */
    static selector = 'textarea[rows][maxlength]';

    /**
     * Can be called directly from class
     * @returns - An HTML element which can be used in constructor
     */
    static findElementInObject(object: OgtTitleWrapper): HTMLTextAreaElement | null {
